    ...
    <section id="elements">
        <div class="view">
            ...
            <div class="content half-size colors-h">
                <h2 class="scroll-in-animation" data-animation="fadeInDown">{!! __('messages.legalConsultancy.company registration') !!}</h2>
                <div class="header-details scroll-in-animation" data-animation="fadeInDown">{!! __('messages.legalConsultancy.company registration') !!}</div>
            </div>
        </div>
    </section>
    <section>
                            ...
                            <div class="col-md-9">
                                <div class="post-body background-10-b">
                                    ...
                                    <h3 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legalConsultancy.company registration') !!}
                                    </h3>
                                    ...
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legalConsultancy.8') !!}
                                    </p>
                                    <h6 class="scroll-in-animation" data-animation="fadeInDown">
                                    ...
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legalConsultancy.16') !!}
                                    </p>
                                    <h6 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legalConsultancy.17') !!}
                                    </h6>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legalConsultancy.18') !!}
                                    </p>
                                    <br>
                                    <br>
                                    <h5 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legalConsultancy.19') !!}
                                    </h5>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legalConsultancy.20') !!}
                                    </p>
                                    ...
                                    <div id="comments">
                                        <h4>2 {{__('messages.legalConsultancy.21')}}</h4>
                                                ...
                                                <div class="comment">
                                                    ...
                                                    <div class="comment-box">
                                                        ...
                                                        <div class="comment-text">
                                                            <p>{{__('messages.legalConsultancy.22')}}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <ul class="children">
                                        ...
                                        <h4 class="scroll-in-animation" data-animation="fadeInDown">{{__('messages.legalConsultancy.23')}}</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 control-group scroll-in-animation" data-animation="fadeInDown">
                                                    <input type="text" name="your-name" value="" size="40"
                                                           placeholder="{{__('messages.legalConsultancy.24')}}"
                                                ...
                                                <div class="col-md-6 control-group scroll-in-animation" data-animation="fadeInDown">
                                                    <input type="email" name="your-email" value="" size="40"
                                                           placeholder="{{__('messages.legalConsultancy.25')}}"
                                                           data-validation-required-message="Please fill the required field."
                                                           required>
                                                    <div class="help-block"></div>
                                                </div>
                                                <div class="col-md-12 control-group scroll-in-animation" data-animation="fadeInDown">
                                                    <textarea name="your-message" placeholder="{{__('messages.legalConsultancy.26')}}"
                                                              data-validation-required-message="Please fill the required field."
                                                              required></textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                                <div class="col-md-12 form-actions scroll-in-animation" data-animation="fadeInDown">
                                                    <input class="button" type="submit" value="{{__('messages.legalConsultancy.27')}}">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
