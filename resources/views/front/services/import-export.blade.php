    ...
    <section id="elements">
        <div class="view">
            ...
            <div class="content half-size colors-h">
                <h2 class="scroll-in-animation" data-animation="fadeInDown">{!! __('messages.importExport.import export') !!}</h2>
                <div class="header-details scroll-in-animation" data-animation="fadeInDown">{!! __('messages.importExport.import export') !!}</div>
            </div>
        </div>
    </section>
    <section>
                            ...
                            <div class="col-md-9">
                                <div class="post-body background-10-b">
                                    ...
                                    <h3 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.importExport.import export') !!}
                                    </h3>
