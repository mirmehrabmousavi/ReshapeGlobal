...
@section('content')
                        ...
                        <div class="row post">
                            ...
                            <div class="col-md-9">
                                <div class="post-body background-10-b">
                                    ...
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.serviceAds.6') !!}
                                    </p>
                                    <h6 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.serviceAds.7') !!}
                                    </h6>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.serviceAds.8') !!}
                                    </p>
                                    <h6 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.serviceAds.9') !!}
                                    </h6>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.serviceAds.10') !!}
                                    </p>
                                    <h6 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.serviceAds.11') !!}
                                    </h6>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
    ...
    <section>
        ...
        <h4 class="text-center">{{__('messages.serviceAds.28')}}</h4>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                {{__('messages.serviceAds.29')}}
                            </a>
                        </h4>
                    </div>
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            {{__('messages.serviceAds.30')}}
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
