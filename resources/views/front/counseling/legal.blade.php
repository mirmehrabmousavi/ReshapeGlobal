...
@section('content')
    ...
    <section id="elements">
        <div class="view">
            ...
            <div class="content half-size colors-h">
                <h2 class="scroll-in-animation" data-animation="fadeInDown">{!! __('messages.legal.company registration') !!}</h2>
                <div class="header-details scroll-in-animation" data-animation="fadeInDown">{!! __('messages.legal.company registration') !!}</div>
            </div>
        </div>
    </section>
    <section>
                ...
                <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="post-body background-10-b">
                                    ...
                                    <h3 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.company registration') !!}
                                    </h3>
                                    ...
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.10') !!}
                                    </p>
                                    <h6 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.11') !!}
                                    </h6>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.12') !!}
                                    </p>
                                    <h6 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.13') !!}
                                    </h6>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.14') !!}
                                    </p>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.16') !!}
                                    </p>
                                    <h6 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.17') !!}
                                    </h6>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.18') !!}
                                    </p>
                                    <br>
                                    <br>
                                    <h5 class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.19') !!}
                                    </h5>
                                    <p class="scroll-in-animation" data-animation="fadeInDown">
                                        {!! __('messages.legal.20') !!}
                                    </p>
                                    ...
                                    <div id="comments">
                                        ...
                                        <h4 class="scroll-in-animation" data-animation="fadeInDown">{{__('messages.legal.23')}}</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 control-group scroll-in-animation" data-animation="fadeInDown">
                                                    <input type="text" name="your-name" value="" size="40"
                                                           placeholder="{{__('messages.legal.24')}}"
                    ...
                    <div class="col-md-3 sidebar page-transition scroll-in-animation" data-animation="fadeInDown">
                        ...
                        <ul dir="ltr">
                            ...
                            <li><a href="{{ route('front.legal') }}">{{ __('messages.header.company registration') }}</a></li>
    ...
    <section>
        ...
        <h4 class="text-center">{{__('messages.legal.28')}}</h4>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                {{__('messages.legal.29')}}
                            </a>
                        </h4>
                    </div>
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            {{__('messages.legal.30')}}
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
